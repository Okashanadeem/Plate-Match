...
export const TopNav: React.FC = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 h-16 border-b border-neutral-800 bg-neutral-900/80 backdrop-blur-md z-50 px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button 
            ...
            className={`p-2 rounded-lg transition-colors ${showSettings ? 'text-blue-400 bg-blue-500/10' : 'text-neutral-400 hover:text-white hover:bg-neutral-800'}`}
          >
      ...
      {showSettings && (
        <FilenameSettings onClose={() => setShowSettings(false)} />
      )}
    </>
  );
};
